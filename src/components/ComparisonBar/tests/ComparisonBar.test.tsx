...
describe('ComparisonBar', () => {
  ...
  test('renders correct CSS classes', () => {
    const { container } = renderWithRouter(
      <ComparisonBar {...defaultProps} selectedOffers={[mockOffer1]} />
    );
  ...
  test('handles offers with long titles', () => {
    const longTitleOffer: MiniOffer = {
      ...mockOffer1,
      title:
        'This is a very long car title that might overflow the container and cause layout issues',
    };
  ...
  test('handles edge case with offers having same id', async () => {
    ...
    renderWithRouter(
      <ComparisonBar {...defaultProps} selectedOffers={[mockOffer1, duplicateOffer]} />
    );
  ...
  test('correctly serializes complex offer data to sessionStorage', async () => {
    ...
    const user = userEvent.setup();
    renderWithRouter(
      <ComparisonBar {...defaultProps} selectedOffers={[mockOffer1, complexOffer]} />
    );
