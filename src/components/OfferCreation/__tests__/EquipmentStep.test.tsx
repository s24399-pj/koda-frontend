...
describe('EquipmentStep', () => {
    ...
    describe('Equipment counter', () => {
        ...
        test('updates counter after item selection', () => {
            ...
            const {rerender} = render(<EquipmentStep formik={formik} onNext={mockOnNext} onPrevious={mockOnPrevious}/>)
    ...
    describe('CSS structure', () => {
        ...
        test('applies equipment-info class to counter', () => {
            ...
            const {container} = render(<EquipmentStep formik={formik} onNext={mockOnNext} onPrevious={mockOnPrevious}/>)
