...
describe('ContactAndSummaryStep', () => {
    ...
    test('displays price without negotiable text when negotiable is false', () => {
        ...
        render(<ContactAndSummaryStep formik={formik} onPrevious={mockOnPrevious} isSubmitting={false}/>)
    ...
    test('preserves form values during re-renders', () => {
        ...
        const {rerender} = render(<ContactAndSummaryStep formik={formik} onPrevious={mockOnPrevious}
                                                         isSubmitting={false}/>)

        expect(screen.getByText('Audi A4 2019')).toBeInTheDocument()
        expect(screen.getByText('Krakow')).toBeInTheDocument()

        rerender(<ContactAndSummaryStep formik={formik} onPrevious={mockOnPrevious} isSubmitting={false}/>)
