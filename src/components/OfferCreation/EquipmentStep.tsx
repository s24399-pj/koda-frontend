    ...
    return (
        <div className="form-step">
                        ...
                        <Field
                            ...
                            render={({ field, form }: FieldRenderProps) => (
                                <input
                                    ...
                                    checked={Boolean(field.value)}
                                    onChange={() => form.setFieldValue('equipment.adaptiveCruiseControl', !field.value)}
                                />
                            )}
                        />
            ...
            {hasSelectedEquipment() && (
                <small className="equipment-info">Wybrano {Object.values(formik.values.equipment || {}).filter(Boolean).length} elementów wyposażenia</small>
            )}
        </div>
    );
};
