...
describe('MessageList', () => {
  ...
  test('renders empty state when no messages', () => {
    ...
    expect(
      screen.getByText('Rozpocznij konwersację wysyłając pierwszą wiadomość')
    ).toBeInTheDocument();
    ...
    const longMessage: ChatMessage[] = [
      {
        ...
        recipientName: 'Jane Smith',
        content:
          'This is a very long message that contains a lot of text to test how the component handles lengthy content without breaking the layout or functionality',
        createdAt: '2024-01-15T10:30:00Z',
        status: 'SENT',
      },
    ];
  ...
  test('renders messages in correct order', () => {
    ...
    const messageElements = screen.getAllByText(
      /Hello there!|Hi! How are you?|I am doing great, thanks!/
    );
