...
describe('SearchUsers', () => {
    ...
    test('shows no results message when search results are empty', () => {
        render(<SearchUsers {...defaultProps} isSearching={true} searchQuery="xyz" searchResults={[]}/>)
    ...
    test('handles empty fullName gracefully', () => {
        ...
        render(<SearchUsers {...defaultProps} isSearching={true} searchResults={[userWithEmptyName]}/>)
    ...
    test('shows multiple active indicators only for active user', () => {
        ...
        render(<SearchUsers {...defaultProps} isSearching={true} searchResults={multipleUsers} activeUserId="user-2"/>)
