...
describe('ConversationList', () => {
    ...
    test('handles keyboard navigation with Enter key', async () => {
        ...
        const firstConversation = screen.getByText('John Doe').closest('[role="button"]') as HTMLElement
        await user.click(firstConversation)
    ...
    test('displays empty state when no conversations', () => {
        ...
        expect(screen.getByText('Wyszukaj użytkownika, aby rozpocząć pierwszy czat')).toBeInTheDocument()
