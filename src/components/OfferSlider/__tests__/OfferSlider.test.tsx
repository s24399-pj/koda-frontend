...
describe('OfferSlider Component', () => {
    const sampleOffers: MiniOffer[] = [
        { id: '1', title: 'Test Offer One', price: 12345, mainImage: '/img1.jpg', mileage: 1000, fuelType: 'PETROL', year: 2020, enginePower: 150, displacement: '1.6L' },
        { id: '2', title: 'Second Offer With A Very Long Title', price: 23456, mainImage: '', mileage: 2000, fuelType: 'DIESEL', year: 2021, enginePower: 120, displacement: '2.0L' }
    ];
    ...
    it('displays error message on fetch failure', async () => {
        ...
        render(<OfferSlider />);
        await waitFor(() => expect(screen.getByText('Error: Failed to fetch offers')).toBeInTheDocument());
    });
