...
export const createOffer = (offerData: CreateOfferCommand) => {
  ...
  return axiosAuthClient.post<OfferResponse>(OFFERS_ENDPOINT, offerData)
    .then(response => {
...
export const getUserOffers = (userId: string) => {
  ...
  return axiosAuthClient.get<OffersResponse>(OFFERS_ENDPOINT, {
    params: { userId }
  })
  .then(response => {
...
export const deleteOffer = (offerId: string) => {
  ...
  return axiosAuthClient.delete(`${OFFERS_ENDPOINT}/${offerId}`)
    .then(response => {
...
export const updateOffer = (offerId: string, offerData: CreateOfferCommand) => {
  ...
  return axiosAuthClient.put<OfferResponse>(`${OFFERS_ENDPOINT}/${offerId}`, offerData)
    .then(response => {
...
export const searchOffers = (
  ...
  return apiClient.post<SearchResponse<any>>(
...
export const getBrands = () => {
  return apiClient.get<{ content: string[] }>('/api/v1/offers/search/brands')
...
export const searchBrands = (phrase: string) => {
  return apiClient.get<{ content: string[] }>('/api/v1/offers/search/brands/search', {
    params: { phrase }
  })
  .then(response => response.data.content || [])
  .catch(error => {
