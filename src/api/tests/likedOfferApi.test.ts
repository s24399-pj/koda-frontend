...
describe('likedOfferApi', () => {
    ...
    describe('getLikedOffers', () => {
        ...
        it('should throw error when request fails', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas pobierania ulubionych ofert:', error)
        })
    })
    ...
    describe('isOfferLiked', () => {
        ...
        it('should return false when request fails', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas sprawdzania statusu polubienia:', error)
        })
        ...
        it('should handle network timeout gracefully', async () => {
            ...
            expect(result).toBe(false)
            expect(console.error).toHaveBeenCalledWith('Błąd podczas sprawdzania statusu polubienia:', timeoutError)
        })
    })
    ...
    describe('likeOffer', () => {
        ...
        it('should throw error when like request fails', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas dodawania oferty do ulubionych:', error)
        })
        ...
        it('should handle 401 unauthorized error', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas dodawania oferty do ulubionych:', unauthorizedError)
        })
        ...
        it('should handle 404 offer not found error', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas dodawania oferty do ulubionych:', notFoundError)
        })
    })
    ...
    describe('unlikeOffer', () => {
        ...
        it('should throw error when unlike request fails', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas usuwania oferty z ulubionych:', error)
        })
        ...
        it('should handle server error gracefully', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas usuwania oferty z ulubionych:', serverError)
        })
        ...
        it('should handle network connectivity issues', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Błąd podczas usuwania oferty z ulubionych:', networkError)
        })
    })
