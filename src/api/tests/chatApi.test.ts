...
describe('ChatService', () => {
    ...
    describe('sendMessage', () => {
        ...
        test('should reconnect and send when not connected', async () => {
            ...
            expect(console.error).toHaveBeenCalledWith('Not connected to WebSocket, attempting to reconnect...')
    ...
    describe('getChatHistory', () => {
        ...
        test('should throw error when token is invalid', async () => {
            ...
            await expect(chatService.getChatHistory('user2')).rejects.toThrow('Token expired - re-authentication required')
        })
    })
